...
_ADDREPLY = _descriptor.Descriptor(
  name='AddReply',
  full_name='pb.AddReply',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='record_count', full_name='pb.AddReply.record_count', index=0,
...
AddReply = _reflection.GeneratedProtocolMessageType('AddReply', (_message.Message,), {
  ...
  '__module__' : 'weather_pb2'
  # @@protoc_insertion_point(class_scope:pb.AddReply)
  })
...
_WEATHER = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='AddTemperature',
    full_name='pb.Weather.AddTemperature',
    index=0,
